...
const InfoBox = () => {
  return (
    ...
    gap-40 flex flex-col md:flex-row items-center justify-center">
      <div className=" w-full md:ml-10 md:w-full md:text-2xl mr-1 ml-2
      flex flex-col  
